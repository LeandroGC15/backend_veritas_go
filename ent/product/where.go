...
func TenantID(v int) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
...
func TenantIDEQ(v int) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldTenantID), v))
	})
}
...
func TenantIDNEQ(v int) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
...
func TenantIDIn(vs ...int) predicate.Product {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TenantIDNotIn(vs ...int) predicate.Product {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TenantIDGT(v int) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
...
func TenantIDGTE(v int) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
...
func TenantIDLT(v int) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
...
func TenantIDLTE(v int) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
